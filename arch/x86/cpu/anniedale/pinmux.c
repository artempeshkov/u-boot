...
static int anniedale_pinctrl_probe(struct udevice *dev)
{
...
static const struct udevice_id anniedale_pinctrl_match[] = {
	{ .compatible = "intel,pinctrl-anniedale", .data = X86_SYSCON_PINCONF },
	{ /* sentinel */ }
};

U_BOOT_DRIVER(anniedale_pinctrl) = {
	.name = "anniedale_pinctrl",
	.id = UCLASS_SYSCON,
	.of_match = anniedale_pinctrl_match,
	.probe = anniedale_pinctrl_probe,
